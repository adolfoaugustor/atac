@foreach($items as $item)
   ...
   @elseif ($item->title =='twitter')
      <li class="animate bounceIn" data-delay="100">
         <a href="{{ $item->link() }}" target="{{ $item->target }}" class="twitter"><i class="icon-twitter-1"></i></a>
      </li>
   @elseif ($item->title =='google-plus')
      <li class="animate bounceIn" data-delay="200">
         <a href="{{ $item->link() }}" target="{{ $item->target }}" class="google-plus"><i class="icon-google"></i></a>
      </li>
