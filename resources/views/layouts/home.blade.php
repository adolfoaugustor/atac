						...
						<ul>
							@foreach($banners as $banner)
								...
								@if($banner->align == 'left')
									{{-- se o align left --}}
									<li data-transition="fade" data-slotamount="5" data-masterspeed="300" data-thumb="{{ asset('storage/' . $banner->image) }}"  data-saveperformance="on"  data-title="">

										<!-- IMAGE -->
										<img src="{{ asset('storage/' . $banner->image) }}"  alt="" data-lazyload="{{ asset('storage/' . $banner->image) }}" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
								...
								@if($banner->align == 'center')
									{{-- se o align center --}}
									<li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-thumb="{{ asset('storage/' . $banner->image) }}"  data-saveperformance="on"  data-title="">
